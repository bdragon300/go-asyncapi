...
func ApplyFilters(artifacts []common.Artifact, layoutItem common.CodeLayoutItemOpts) []common.Artifact {
...
func buildFiltersChain(layoutItem common.CodeLayoutItemOpts) []filterFunc {
