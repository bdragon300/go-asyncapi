...
type GoStruct struct {
	...
	// Typically it's ObjectKindLang or ObjectKindSchema
...
type GoStructField struct {
	...
	TagsSource     *ListPromise[*render.Message] // FIXME: rework this
...
//		tagNames := lo.Uniq(lo.FilterMap(f.TagsSource.Targets(), func(item *render.Message, _ int) (string, bool) {
