...
type RenderNamespace struct {
	...
	implementations []RenderImplementationDefinition
	names           []string
}
...
type RenderImplementationDefinition struct {
	Object   common.ImplementationObject
	Directory  string   // Evaluated template expression
}

func (s *RenderNamespace) AddType(obj common.GolangType, selection common.ConfigSelectionItem, actual bool) {
...
func (s *RenderNamespace) AddImplementation(object common.ImplementationObject, directory string) {
	s.implementations = append(s.implementations, RenderImplementationDefinition{Object: object, Directory: directory})
}

func (s *RenderNamespace) FindType(obj common.GolangType) (RenderTypeDefinition, bool) {
...
func (s *RenderNamespace) Implementations() []RenderImplementationDefinition {
	return s.implementations
}

func (s *RenderNamespace) Clone() RenderNamespace {
	return RenderNamespace{
		types:           append([]RenderTypeDefinition(nil), s.types...),
		implementations: append([]RenderImplementationDefinition(nil), s.implementations...),
