...
//	return "WS ProtoChannel " + pc.Parent.GetOriginalName
//}
//
...
//					bg.Op(`
//						if err := message.MarshalEnvelopeWs(envelope); err != nil {
//							return err
//						}`)
//				}
//				// Message SetBindings
...
//						j.Add(utils.ToCode(pc.Parent.PublisherMessageTypePromise.Target().BindingsType.U(ctx))...).Values().Dot("WS()"),
//					)
//				}
//				bg.Return(j.Nil())
//			}),
