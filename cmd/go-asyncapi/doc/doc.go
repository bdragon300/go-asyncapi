...
func cliConfig(globalConfig common2.ToolConfig, cmd *Cmd) (common2.ToolConfig, error) {
	...
	res.Doc.Cp.RecursiveShallow = common2.Coalesce(cmdCp.RecursiveShallow, globalConfig.Doc.Cp.RecursiveShallow)
	...
	res.Doc.Mv.RecursiveShallow = common2.Coalesce(cmdMv.RecursiveShallow, globalConfig.Doc.Mv.RecursiveShallow)
